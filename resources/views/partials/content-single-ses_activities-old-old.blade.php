        ...
        <div class="col-12">
          <div class="full-width global-padding dark-bg">
            <div class="container">
              ...
              <div class="row">
                <div class="col-12 col-lg-3 col-xl-2 white-row activity-buttons">
                  ...
                  @foreach ($month_order as $month)
                    ...
                    @endphp
                    <button class="btn btn-white btn-pink-hover btn-full d-none d-lg-block {{ $month == $current_month ? 'active' : '' }}" data-month-for="{{$month}}">{{$monthName}}</button>
                    @php
